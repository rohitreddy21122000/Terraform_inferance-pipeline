...
locals {
  resource_arn = var.api_type == "HTTP" ? "arn:aws:apigateway:${var.region}::/apis/${var.api_id}/stages/${var.stage_name}" : "arn:aws:apigateway:${var.region}::/restapis/${var.api_id}/stages/${var.stage_name}"
}
